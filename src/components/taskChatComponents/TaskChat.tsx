...
//                         />
//                         <div className="w-full   rounded-lg p-3 mb-2  text-sm">
...
//                       <div className="w-full   rounded-lg p-3 mb-2  text-sm">
//                                         <strong>Summary:</strong>
//                                         <div className=" text-base font-mono">{summary}   
//                                         </div>
//                                       </div>
//                   </div>
//                   )}
...
//               rows={2}
//             />
//             <Button onClick={handleSendMessage} className='' disabled={!newMessage.trim()}>
  ...
  return (
   ...
   />
      ...
      <div className={chatWidthClass}>
        ...
        <div className="w-full max-w-6xl mx-auto px-4 py-1 bg-gradient-to-r from-gray-50 to-white border-b border-gray-100">
